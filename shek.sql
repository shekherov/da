...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 06 2024 г., 11:41
...
INSERT INTO `dishes` (`id_dishes`, `name`, `Cooking_Method`, `Cooking_Time_in_min`, `id_categories`) VALUES
(1, 'Шашлык - Мясной обитель - свиной', 'Копчение на углях', 120, 1),
(2, 'Шашлык - Благосклонность природы - грибной', 'Копчение на углях', 120, 1),
(3, 'Шашлык - Рай из глубин - рыбный', 'Копчение на углях', 120, 1),
(4, 'Суп - Котёл тысячи сердец - Борщ', 'Варка', 90, 2),
(5, 'Суп - Всё из ничего - Солянка', 'Варка', 90, 2),
(6, 'Суп - Сногсшибательный - Гороховый', 'Варка', 90, 2),
(7, 'Салат - Новогодний – Цезарь', 'Смешивание ингредиентов', 25, 3),
(8, 'Салат - Деревенский – Ёжик', 'Смешивание ингредиентов', 15, 3),
(9, 'Салат - Поход дьявола - Винегрет', 'Смешивание ингредиентов', 40, 3);
